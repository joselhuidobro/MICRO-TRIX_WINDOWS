...
class OrdenSemana(db.Model):
    __tablename__ = 'ordenes_semana'
    ...
    en_ruta = db.Column(db.Boolean, default=False)  # Boolean para "si" o "no"
    ...
    def __init__(self, cel, nombre, fecha, direccion=None, concepto=None, categoria=None,
                 ...
                 cambiar_estado=False, horario=None, unidad_trix=None, lat=None, lon=None, en_ruta=None):
        self.cel = cel
        self.nombre = nombre
        self.fecha = fecha
        ...
        self.lat = lat
        self.lon = lon
        self.en_ruta = en_ruta
        

    def __repr__(self):
        return f"<OrdenSemana(id={self.id}, nombre='{self.nombre}', fecha={self.fecha}>"
